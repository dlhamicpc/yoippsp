...
Route::put('/update_personal_details', 'API\InnerWebsite\PersonalUserController@update_personal_details');


//update languages,time_zone
Route::put('/update_languages_time_zone', 'API\InnerWebsite\PersonalUserController@update_languages_time_zone');


//update email
Route::put('/update_email', 'API\InnerWebsite\PersonalUserController@update_email');


//update mobile_number
Route::put('/update_mobile_number', 'API\InnerWebsite\PersonalUserController@update_mobile_number');


//update password
Route::put('/update_password', 'API\InnerWebsite\PersonalUserController@update_password');


//update notification
Route::put('/update_notification_settings', 'API\InnerWebsite\PersonalUserController@update_notification_settings');


//update security
Route::put('/update_security_settings', 'API\InnerWebsite\PersonalUserController@update_security_settings');


//update profile avatar
Route::put('/update_avatar', 'API\InnerWebsite\PersonalUserController@update_avatar');
...
//Pay Bill
Route::post('/pay_bill', 'API\InnerWebsite\Transaction\BillPaymentTransactionController@bill_payment_transaction');
