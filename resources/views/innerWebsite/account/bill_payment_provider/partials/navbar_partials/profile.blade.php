   ...
   <li class="nav-item dropdown">
        ...
        <router-link to="/bpa/profile" onclick="closeSideBar();">
        <div class="user-panel mt-2 pb-2 d-flex">
            ...
            <span class="d-block" id="full_name_nav_bar">{{ ucwords($billPaymentUser->full_name) }}</span>
          ...
          <router-link to="/bpa/profile" class="dropdown-item" onclick="closeSideBar();">
