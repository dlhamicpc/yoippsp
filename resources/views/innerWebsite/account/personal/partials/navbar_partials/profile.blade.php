   ...
   <li class="nav-item dropdown">
        ...
        <router-link to="/pa/profile" onclick="closeSideBar();">
        <div class="user-panel mt-2 pb-2 d-flex">
            ...
            <span class="d-block" id="full_name_nav_bar">{{ ucwords($personalUser->full_name) }}</span>
          ...
          <router-link to="/pa/profile" class="dropdown-item" onclick="closeSideBar();">
