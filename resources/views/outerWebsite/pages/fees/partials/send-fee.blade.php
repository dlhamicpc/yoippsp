          ...
          <div class="col-md-6 mb-5">
            <div class="bg-white shadow-sm rounded p-4 text-center">
              <div class="featured-box style-4 py-2">
                <div class="featured-box-icon text-light border rounded-circle shadow-none"> <i class="fas fa-money-bill"></i> </div>
                ...
                <div class="text-primary text-10 pt-3 pb-4 mb-2">up to 0.25%</div>
