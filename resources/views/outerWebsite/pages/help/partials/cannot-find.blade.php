              ...
              <div class="row no-gutters">
                ...
                <div class="col text-center text-sm-left">
                  <div class="">
                    ...
                    <p class="text-muted mb-0">We want to answer all of your queries. Get in touch and we'll get back to you as soon as we can. 
                    <a class="btn-link" href="{{ url('/contact') }}">Contact us<span class="text-1 ml-1"><i class="fas fa-chevron-right"></i></span></a></p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="row no-gutters">
                ...
                <div class="col text-center text-sm-left">
                  <div class="">
                    ...
                    <a class="btn-link" href="{{ url('/contact') }}">Click here<span class="text-1 ml-1"><i class="fas fa-chevron-right"></i></span></a></p>
                  </div>
                </div>
              </div>
            </div>
