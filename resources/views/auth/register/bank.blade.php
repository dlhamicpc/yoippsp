...
<head>
    ...
    <title>@appName Bank Registration</title>
  ...
  <body>
            ...
            <div class="row">
              <div class="form-group col-12 col-md-12">
                    <select class="form-control"
                      ...
                      <option  value="">Select Bank Headquarter Country</option>
              ...
              <div class="form-group col-12 col-md-12">
                    <select class="form-control "
                            ...
                            oninput=" validate(event, 'required|integer') "
                            required>
                            <option value="">Select Bank Headquarter State</option>
              ...
              <div class="form-group col-12 col-md-12">
                    <select class="form-control"
                            ...
                            oninput=" validate(event, 'required|integer') "
                            required>
                            <option  value="">Select Bank Headquarter City</option>
            ...
            <div class="row">
                <div class="form-group col-md-12">
                  <input type="text"
                        ...
                        placeholder="Bank Name eg.Awash"
                        name="bank_name"
                        value="{{ old('bank_name') }}"
                        id="bank_name"
                        ...
                        required>
                  <div class="form-control" id="bank_nameError" style="display: none;">
             ...
             <div class="row">
                <div class="form-group col-md-12">
                  <input type="text"
                        class="form-control in"
                        placeholder="Bank Headquarter Address"
                        name="bank_headquarter"
                        value="{{ old('bank_headquarter') }}"
                        id="bank_headquarter"
                        onblur=" validate(event, 'required|alpha_space') "
                        oninput=" validate(event, 'required|alpha_space') "
                        required>
                  <div class="form-control" id="bank_headquarterError" style="display: none;">
          ...
          <div class="tab tabThree mt-5" id="loading" style="margin-top:20px;">
            <center><div class="row">
                <div class="form-group col-md-12 load" style="">
                  <img src="{{ asset('/images/collection/uni_loader.gif') }}">
                </div>
                <br><br>
    ...
    <script src="{{ asset('/js/tabHandler_bank.js') }}" type="text/javascript"></script>
