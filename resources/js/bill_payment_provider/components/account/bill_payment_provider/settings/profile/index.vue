<template>
    ...
    <div class="row">
        ...
        <aside class="col-lg-3">
                ...
                <dashboard-need_help></dashboard-need_help>
        ...
        <div class="col-lg-9">
          ...
          <view-bill-payment-provider-details></view-bill-payment-provider-details>
          <edit-bill-payment-provider-details></edit-bill-payment-provider-details>
          ...
          <view-mobile-number></view-mobile-number>
...
<script>
    ...
    export default {
        ...
        methods:{
          format_mobile_number( mobile_number ){
