<template>
    ...
    <!-- Edit Details Modal================================== -->
    <div id="edit-bill-payment-provider-details" class="modal fade " role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title font-weight-400">Bill Payment Provider Details</h5>
                  <button type="button" class="close font-weight-400" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">&times;</span> </button>
                </div>
                <div class="modal-body p-4">


                  <form id="form_edit_bill_payment_provider_details" method="post" @submit.prevent="">
                    <div class="row">
                      <div class="col-12 col-sm-6">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text"
                                value="" 
                                v-model="form_edit_bill_payment_provider_details.administrator_name"
                                class="form-control"  
                      ...
                      <div class="col-12 col-sm-6">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" 
                                value="" 
                                v-model="form_edit_bill_payment_provider_details.administrator_father_name"
                                class="form-control" 
                          ...
                          <div class="form-group">
                            ...
                            <div class="position-relative">
                              <input id="company_name"
                                    name="company_name" 
                                    value=""
                                    v-model="form_edit_bill_payment_provider_details.company_name"
                                    type="text" 
                                    class="form-control" 
                                    required=""
                                    onblur=" validate(event, 'required') "
                      ...
                      <div class="col-12">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" 
                                value=""
                                v-model="form_edit_bill_payment_provider_details.headquarter_address" 
                                class="form-control" 
                      ...
                      <div class="col-12 col-sm-6">
                        ...
                        <div class="form-group">
                            <select class="custom-select" 
                                    id="city" 
                                    name="city"
                                    v-model="form_edit_bill_payment_provider_details.city"
                      ...
                      <div class="col-12 col-sm-6">
                        <div class="form-group">
                          ...
                          <select class="custom-select" 
                                  id="state" 
                                  name="state"
                                  v-model="form_edit_bill_payment_provider_details.state"
                                  onblur=" validate(event, 'required|integer') "
                                  oninput=" validate(event, 'required|integer') "
                                  @blur="validate_data()"
                                  @input="validate_data()"
                      ...
                      <div class="col-12 col-sm-6">
                        ...
                        <div class="form-group">
                          ...
                          <input id="headquarter_home_number"
                              ...
                              value="" 
                              v-model="form_edit_bill_payment_provider_details.headquarter_home_number"
                              type="text" 
                              class="form-control"
                      ...
                      <div class="col-12 col-sm-6">
                        ...
                        <div class="form-group">
                          ...
                          <select class="custom-select" 
                                  id="country" 
                                  name="country"
                                  v-model="form_edit_bill_payment_provider_details.country"
                                  onblur=" validate(event, 'required|integer') "
                                  oninput=" validate(event, 'required|integer') "
                                  @blur="validate_data()"
                                  @input="validate_data()">
                    ...
                    @click="update_bill_payment_provider_details"
          ...
          <!-- Edit Bill Payment Provider Details End -->
...
<script>
    export default {
        mounted() {
          ...
          ECHO.$on('UPDAT_BILL_PAYMENT_PROVIDER_DETAILS', (data)=>{
        ...
        data(){
            return{
              form_edit_bill_payment_provider_details: new Form({
                    ...
                    company_name: this.userDetails.bill_payment_name,
                }),
        ...
        methods: {
            ...
            ,
            validate_data(){
                let form_edit_bill_payment_provider_details = document.forms["form_edit_bill_payment_provider_details"];

                for( let index = 0; index < form_edit_bill_payment_provider_details.length - 1; index++ ){

                    let input = form_edit_bill_payment_provider_details.elements[ index ];
                    ...
                    if( input.id == 'headquarter_headquarter_address' || input.id == 'headquarter_home_number' ){
                      continue;
                    }
                    ...
                    else if( this.form_edit_bill_payment_provider_details.busy ){
                        this.isInvalid = true;
                        return;
                    }
            ...
            update_bill_payment_provider_details(){

                this.validate_data();
                ECHO.$emit('START_LOADING');

                this.form_edit_bill_payment_provider_details.date_of_birth =  $('#date_of_birth').val();

                this.form_edit_bill_payment_provider_details.put('api/update_bill_payment_provider_details')
                    .then(( response )=>{
                        ...
                        if( data == 'failed' ){
                          ...
                          ECHO.$emit('UPDATE_BILL_PAYMENT_PROVIDER_DETAILS', data);
                          Vue.prototype.userDetails = data;

                          this.update_full_name_side_nav_bar( data );

                          $('#edit-bill-payment-provider-details').modal('hide');
                          toast.fire({
                                type: 'success',
                                title: 'Bill Payment Provider Details Updated Successfully'
            ...
            invalid_administrator_name( ){
                ...
                ID( 'administrator_nameError' ).innerHTML = this.form_edit_bill_payment_provider_details.errors.errors.administrator_name;
            }
            ,

            invalid_administrator_father_name( ){
                StyleError( 'administrator_father_name', 'administrator_father_nameError' );
                ID( 'administrator_father_nameError' ).innerHTML = this.form_edit_bill_payment_provider_details.errors.errors.administrator_father_name;
            }
            ,

            invalid_company_name( ){
                StyleError( 'company_name', 'company_nameError' );
                ID( 'company_nameError' ).innerHTML = this.form_edit_bill_payment_provider_details.errors.errors.company_name;
            }
            ,

            invalid_headquarter_address( ){
                StyleError( 'headquarter_address', 'headquarter_addressError' );
                ID( 'headquarter_addressError' ).innerHTML = this.form_edit_bill_payment_provider_details.errors.errors.company_name;
            }
            ,

            invalid_date_of_birth( ){
                StyleError( 'date_of_birth', 'date_of_birthError' );
                ID( 'date_of_birthError' ).innerHTML = this.form_edit_bill_payment_provider_details.errors.errors.date_of_birth;
            }
            ,

            invalid_country( ){
                StyleError( 'country', 'countryError' );
                ID( 'countryError' ).innerHTML = this.form_edit_bill_payment_provider_details.errors.errors.country;
            }
            ,

            invalid_city( ){
                StyleError( 'city', 'cityError' );
                ID( 'cityError' ).innerHTML = this.form_edit_bill_payment_provider_details.errors.errors.city;
            }
            ,

            invalid_state( ){
                StyleError( 'state', 'stateError' );
                ID( 'stateError' ).innerHTML = this.form_edit_bill_payment_provider_details.errors.errors.state;
            }
            ,

            invalid_headquarter_headquarter_address( ){
                StyleError( 'headquarter_headquarter_address', 'headquarter_headquarter_addressError' );
                ID( 'headquarter_headquarter_addressError' ).innerHTML = this.form_edit_bill_payment_provider_details.errors.errors.headquarter_headquarter_address;
            }
            ,

            invalid_headquarter_home_number( ){
                StyleError( 'headquarter_home_number', 'headquarter_home_numberError' );
                ID( 'headquarter_home_numberError' ).innerHTML = this.form_edit_bill_payment_provider_details.errors.errors.headquarter_home_number;
            }
            ,

            show_error_to_update_modal( ){

                if ( this.form_edit_bill_payment_provider_details.errors.any() ){

                    if( this.form_edit_bill_payment_provider_details.errors.has('administrator_name') ){
                        this.invalid_administrator_name();
                    }

                    if( this.form_edit_bill_payment_provider_details.errors.has('administrator_father_name') ){
                        this.invalid_administrator_father_name();
                    }

                    if( this.form_edit_bill_payment_provider_details.errors.has('date_of_birth') ){
                        this.invalid_date_of_birth();
                    }

                    if( this.form_edit_bill_payment_provider_details.errors.has('headquarter_address') ){
                        this.invalid_headquarter_address();
                    }

                    if( this.form_edit_bill_payment_provider_details.errors.has('company_name') ){
                        this.invalid_company_name();
                    }

                    if( this.form_edit_bill_payment_provider_details.errors.has('country') ){
                        this.invalid_country();
                    }

                    if( this.form_edit_bill_payment_provider_details.errors.has('city') ){
                        this.invalid_city();
                    }

                    if( this.form_edit_bill_payment_provider_details.errors.has('headquarter_headquarter_address') ){
                        this.invalid_headquarter_headquarter_address();
                    }

                    if( this.form_edit_bill_payment_provider_details.errors.has('headquarter_home_number') ){
                        this.invalid_headquarter_home_number();
                    }

                    if( this.form_edit_bill_payment_provider_details.errors.has('state') ){
                        this.invalid_state();
                    }
