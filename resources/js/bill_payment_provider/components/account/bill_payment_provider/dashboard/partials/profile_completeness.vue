              ...
              <div class="col-sm-6 col-md-3 mb-4 mb-sm-0">
                <div class="border rounded p-3 text-center"> 
                  ...
                  <p class="mb-0" v-else-if="!profileChecks.userCardLinksCheck">
                    <router-link to="/bpa/card" class="btn-link stretched-link" href="">Add Card</router-link>
                  </p>
              ...
              <div class="col-sm-6 col-md-3">
                <div class="border rounded p-3 text-center"> 
                  ...
                  <p class="mb-0" v-else-if="!profileChecks.userBankLinksCheck">
                      <router-link to="/bpa/card" class="btn-link stretched-link" href="">Add Bank Account</router-link>
                  </p>
